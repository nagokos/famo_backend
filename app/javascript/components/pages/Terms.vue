<template>
  <div class="terms">
    <v-card elevation="0" :class="$vuetify.breakpoint.mobile ? '' : 'mt-15 '" :color="$vuetify.breakpoint.mobile ? '#FAFAFA' : 'white'">
      ...
      <v-divider />
      <v-card-text :class="$vuetify.breakpoint.mobile ? 'px-1 black--text mt-3' : 'px-10 black--text mt-3'">
        <v-container>
          <v-row>
            <v-col cols="12">
              この利用規約（以下、「本規約」といいます。）は、本ウェブサイト上で提供するサービス（以下、「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下、「ユーザー」といいます。）には、本規約に同意して頂いたうえで、本サービスをご利用いただきます。
            </v-col>
            ...
            <v-col cols="12" class="pt-0">
              本サービスにおいては、登録希望者が本規約に同意の上、登録手続きを行うことができるものとします。
            </v-col>
            <v-col cols=12 :class="$vuetify.breakpoint.mobile ? 'text-h6 font-weight-bold mt-3' : 'text-h5 font-weight-bold mt-5'">
            ...
            <v-col cols=12 class="pt-0">
              <ol>
                ...
                <li>
                  ユーザーは、いかなる場合にも、ユーザーIDおよびパスワードを第三者に譲渡または貸与し、もしくは第三者と共用することはできません。本サービスで、ユーザーIDとパスワードの組み合わせが登録情報と一致してログインされた場合には、そのユーザーIDを登録しているユーザー自身による利用とみなします。
                </li>
                <li>
                  本サービスで、会員ID及びパスワードの盗用、不正利用等により会員のアカウントが当該会員以外の第三者に利用された場合であっても、それにより当該会員に生じた損害について一切責任を負わないものとします。
                </li>
              </ol>
            </v-col>
            <v-col cols=12 :class="$vuetify.breakpoint.mobile ? 'text-h6 font-weight-bold mt-3' : 'text-h5 font-weight-bold mt-5'">
            ...
            <v-col cols="12" class="pt-0">
              運営者は、本サービスの利用によって取得する個人情報については、<span class="blue--text text--darken-2" style="cursor: pointer;" @click="$router.push({ name: 'privacy' }, () => {})">プライパシーポリシー</span>に従い適切に取り扱うものとします。
            </v-col>
            <v-col cols=12 :class="$vuetify.breakpoint.mobile ? 'text-h6 font-weight-bold mt-3' : 'text-h5 font-weight-bold mt-5'">
              第12条（通知または連絡）
            </v-col>
